...
@keyframes spCircRot {
  ...
  `;static properties={_courses:{state:!0}};static properties={_loading:{state:!0}};constructor(){super(),this.getCourses(),this._courses={},this.loading=!0,this.isAdmin=!1,this.online=navigator.onLine,this.currentCourse}_offline(){this.online=!1,this.requestUpdate()}_online(){this.online=!0,this.requestUpdate()}async getCourses(){try{const t=await fetch("get-remote-courses.php"),e=await t.json();if(!1===e.success)return this.loading=!1,this.online=!1,void this.requestUpdate();this._courses=e,this.loading=!1,this.requestUpdate()}catch(t){this.loading=!1,this.online=!1,this.requestUpdate()}}connectedCallback(){super.connectedCallback(),nt().then((t=>{t&&(this.isAdmin=!0,this.requestUpdate())})),syncObj.syncCourseForums(4).then((t=>{console.log("Done"),console.log(t)})).catch((t=>{console.error("Failed"),console.warn(t)})),window.addEventListener("offline",(()=>this._offline())),window.addEventListener("online",(()=>this._online()));const t=document.querySelector("#page-content")?.getBoundingClientRect();t&&(this.style.height=t.height-62+"px")}offlineView(){return N`<div class="loading">
    ${O`<svg xmlns="http://www.w3.org/2000/svg" height="48" width="48"><path d="m40.9 45.2-5.75-5.75H12.4Q8 39.45 5 36.5t-3-7.35q0-4 2.525-6.7t6.325-3.3q.1-.7.325-1.575T11.8 16L3.5 7.7l2.1-2.1 37.45 37.45Zm-28.5-8.75h19.85l-18-18q-.55.75-.725 1.7-.175.95-.175 1.85h-.95q-3.1 0-5.25 1.975T5 29q0 3.1 2.15 5.275Q9.3 36.45 12.4 36.45Zm10.8-9.05Zm19.5 10.5-2.35-2.35q1.25-.85 1.95-1.9.7-1.05.7-2.5 0-2.15-1.55-3.675t-3.7-1.525H34.4V21.9q0-4.4-3.05-7.375-3.05-2.975-7.45-2.975-1.4 0-3.025.45T17.9 13.45l-2.1-2.1q1.8-1.45 3.875-2.125T23.9 8.55q5.55 0 9.525 3.95Q37.4 16.45 37.4 22v1.05Q41 23 43.5 25.3q2.5 2.3 2.5 5.85 0 1.75-.825 3.675Q44.35 36.75 42.7 37.9ZM29.15 24.5Z"/></svg>`}
        ...
        `:this.offlineView():N`<div>Unauthorized</div>`}async deleteAllCourses(){const t=await fetch("delete-courses.php"),e=await t.json();console.log("Delete existing course",e)}async _downloadCourses(){this.loading=!0,this.requestUpdate(),await this._uploadAllCoursesUsersData(),await this.deleteAllCourses(),this.loading=!1,this.requestUpdate();for(const t of Object.values(this._courses))1!=t.id&&(t.downloading=!0,this._courses[t.id]=t,this.requestUpdate(),await this._downloadCourse(t.id),t.downloading=!1,t.downloadComplete=!0,this._courses[t.id]=t,this.requestUpdate())}async _downloadCourse(t){const e=await fetch(`download-remote-course.php?course_id=${t}`);if(!e.ok){const t=`${e.status}: ${e.statusText}`;return console.error(t),{message:t}}const s=await e.text();return JSON.parse(s).success}async _uploadUserData(t){const e=`sync-to-online.php?course_id=${t}`,s=await fetch(e),i=await fetch(`/local/coursebackup/course-feedback.php?course_id=${t}`),o=await i.json(),n=await fetch("http://197.243.24.148/local/coursebackup/sync-course-feedback.php",{method:"post",body:JSON.stringify(o)}),r=await n();console.log(r);try{const t=await s.json();return console.log(t),t}catch(t){console.error(t)}}async _uploadAllCoursesUsersData(){for(const t of Object.values(this._courses))1!=t.id&&(t.downloading=!0,this._courses[t.id]=t,this.requestUpdate(),await this._uploadUserData(t.id),t.downloading=!1,t.downloadComplete=!0,this._courses[t.id]=t,this.requestUpdate())}}return customElements.define("main-section",rt),customElements.define("f-loading",ot),(async()=>{if(await nt())return;const t=`${document.location.origin}/local/coursebackup/manage.php`,e=document.querySelector(`a[href="${t}"]`);if(!e)return void console.error("Sync page link not found");const s=e.parentElement;s.parentElement.removeChild(s)})(),t.App=rt,Object.defineProperty(t,"__esModule",{value:!0}),t}({});
